...
| 版本 | 文件 | 大小 | 说明 |
| --- | --- | --- | --- |
| 2.3.0 | [`91-client-v2.3.0.apk`](https://github.com/whooc/91-android-client/raw/main/apk/91-client-v2.3.0.apk) | 2.4 MB | 最新版，推荐。短视频画面完整显示 + 双指缩放 |
...
```bash
# 直接下载最新版
curl -LO https://github.com/whooc/91-android-client/raw/main/apk/91-client-v2.3.0.apk
...
| 文件 | SHA-256 |
| --- | --- |
| `91-client-v2.3.0.apk` | `31fb12f0eeb083921465aaeda0c0df2da23e89c961d119b5fa6e120c627881e7` |
...
- 2.3.0 起短视频画面**按真实比例完整显示**（不再裁剪）并支持**双指缩放 1x–5x**，
